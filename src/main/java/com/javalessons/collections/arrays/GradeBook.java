...
public class GradeBook {
    ...
    private static void varArgs() {
        ...
        System.out.println("Average if 2 elements: " + calcAverage(a, b));
        System.out.println("Average if 2 elements: " + calcAverage(a, b, c));
        System.out.println("Average if 2 elements: " + calcAverage(a, b, c, d));
