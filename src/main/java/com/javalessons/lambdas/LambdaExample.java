...
/**
 * Functional interface - an interface that have only one "abstract" method, rest of the methods will be declared as "default"
 */
@FunctionalInterface
...
//        processElements(intList, x -> multiply(x));

        /**  Verify how much time it takes a method to be executed */
